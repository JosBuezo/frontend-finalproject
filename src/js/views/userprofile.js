				...
				<div className="content">
					<Row>
						<Col md="8">
							<Card>
								<CardHeader>
									<h5 className="title">Welcome User!</h5>
								</CardHeader>
								<CardBody>
									<Form>
										<Row>
											<Col className="pr-md-1" md="5">
												<FormGroup>
													<label>Luxuria Classic Auto</label>
													<Input
														defaultValue="Luxuria Classic Auto Inc."
														disabled
														placeholder="Luxuria Classic Auto Inc."
														type="text"
													/>
												</FormGroup>
											</Col>
											<Col className="px-md-1" md="3">
												<FormGroup>
													...
													<Input defaultValue="gitpod" placeholder="Username" type="text" />
												</FormGroup>
											</Col>
										...
										<Row>
											...
											<Col className="pl-md-1" md="6">
												<FormGroup>
													...
													<Input defaultValue="Buezo" placeholder="Last Name" type="text" />
												</FormGroup>
											</Col>
										</Row>
										<Row>
									...
									<div className="author">
										...
										<a href="#" onClick={e => e.preventDefault()}>
											<img
												...
												className="avatar"
												src={
													"https://www.reanimefilms.com/wp-content/uploads/2019/02/avatar-aang.png"
												}
											/>
